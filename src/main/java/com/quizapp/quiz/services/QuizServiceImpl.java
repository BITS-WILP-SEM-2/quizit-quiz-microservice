...
public class QuizServiceImpl implements QuizService {
	...
	public Map<String, Long> getAdminStats(String authorization){
		...
		ResponseEntity<List> totalUsers= restTemplate.exchange("https://users-service.cfapps.us10-001.hana.ondemand.com/users/getall", HttpMethod.GET, entity, List.class);
